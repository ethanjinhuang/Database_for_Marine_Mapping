...
Qt=diag(w.^2);     Rk=diag(v.^2);    Pk=diag(x0.^2);    Xk=zeros(12,1);
    ...
    for k=2 :2: 1829*100  
        ...
        if mod(k, 10)==0
            ...
            if mod(k,100)==0      
                ...
                [Xk, Pk] = kfilter(Ft, Xk, Qt, Ht, Zk, Rk, Pk, TKF, 12);
                %%%%%  fi    dvn   dpos 10  dposD
