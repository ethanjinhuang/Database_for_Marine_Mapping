...
%系统状态初值设置
fi = [5 ; 5; 10]*min;     dvn = [.1; .1; .1];           dpos = [20/Re; 20/Re; 10];	
...
Qt=diag(w.^2);     Rk=diag(v.^2);    Pk=diag(x0.^2);    Xk=zeros(21,1);
    ...
    for k=2 :2: 1000*100  
        ...
        if mod(k,100)==0   
            ...
            Zk=[vnm; posm-pos];
            [Xk, Pk] = kfilter(Ft, Xk, Qt, Ht, Zk, Rk, Pk, TKF, 21);
...
global Re e g0 wie tao Rv
    ...
    %%%%%  fi    dvn   dpos   dKG   eb    dKA   db  21    
    Ft = [ -S1   M2    M13    -S2   -Cnb  o3    o3     ;
           S3    M4    M5     o3    o3    S4    Cnb    ;
           o3    M6    M7     o3    o3    o3    o3     ;
           o3    o3    o3     o3    o3    o3    o3     ;
           o3    o3    o3     o3    aG    o3    o3     ;
           o3    o3    o3     o3    o3    o3    o3      ;
           o3    o3    o3     o3    o3    o3    o3      ]; 
                    
    Ht = [ o3    I3    o3     o3    o3    o3    o3      ;
           o3    o3    I3     o3    o3    o3    o3       ];
